...
#include "VanLeerRSF_F.H"

VanLeerRS::VanLeerRS( void )
{
}

RiemannSolver * VanLeerRS::new_RiemannSolver()
{
  VanLeerRS * retval = new VanLeerRS();

  return static_cast<RiemannSolver*>(retval);
}

void VanLeerRS::fluxes(       FArrayBox & a_F,
