#include "DednerRS.H"
#include "Roe7WaveF_F.H"
#include "DednerF_F.H"
#include "RiemannSolverF_F.H"

DednerRS::DednerRS( void )
...
RiemannSolver * DednerRS::new_RiemannSolver()
{
  DednerRS * retval = new DednerRS();
...
void DednerRS::setParameters( double EntFix, double dSmallB,
                                 int    iAver,  int    iLF )
{
...
void DednerRS::fluxes(       FArrayBox & a_F,
