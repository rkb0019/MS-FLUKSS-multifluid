...
#include "RoeHHTRSF_F.H"

RoeHHTRS::RoeHHTRS( void )
{
}

RiemannSolver * RoeHHTRS::new_RiemannSolver()
{
  RoeHHTRS * retval = new RoeHHTRS();

  return static_cast<RiemannSolver*>(retval);
}

void RoeHHTRS::fluxes(       FArrayBox & a_F,
