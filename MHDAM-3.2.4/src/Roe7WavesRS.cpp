...
RiemannSolver * Roe7WavesRS::new_RiemannSolver()
{
  Roe7WavesRS * retval = new Roe7WavesRS();
...
void Roe7WavesRS::setParameters( double EntFix, double dSmallB,
                                 int    iAver,  int    iLF )
{
...
void Roe7WavesRS::fluxes(       FArrayBox & a_F,
